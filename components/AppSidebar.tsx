...
const ICONS = {
  ...
  // Popcorn outline: three overlapping puffs forming one piece
  box:       "M12 10m-5 0a5 5 0 1 0 10 0a5 5 0 1 0-10 0M8 15m-4 0a4 4 0 1 0 8 0a4 4 0 1 0-8 0M16 15m-4 0a4 4 0 1 0 8 0a4 4 0 1 0-8 0",
